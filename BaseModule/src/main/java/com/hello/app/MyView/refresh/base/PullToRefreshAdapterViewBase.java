...
import com.hello.app.MyView.refresh.internal.IndicatorLayout;
import com.hello.app.R;

public abstract class PullToRefreshAdapterViewBase<T extends AbsListView>
        extends PullToRefreshBase<T> implements
        OnScrollListener {
     ...
     * {@link com.hello.app.MyView.refresh.base.PullToRefreshBase.Mode#PULL_FROM_START}. The default
     * value is <var>true</var> if
    ...
    public final void onScroll(final AbsListView view, final int firstVisibleItem,
        ...
        if (DEBUG) {
            Log.d(LOG_TAG,
                    "First Visible: " + firstVisibleItem + ". Visible Count: " + visibleItemCount
     ...
     * a state where a Pull-to-Refresh can happen. An example of this state is
     * when the Adapter View is scrolled to the top and the mode is set to
     * {@link com.hello.app.MyView.refresh.base.PullToRefreshBase.Mode#PULL_FROM_START}
     *
