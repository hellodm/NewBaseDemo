package com.hello.app.MyView.ViewPager;
...
public class RecyclerViewPagerAdapter<VH extends RecyclerView.ViewHolder>
    ...
    public void onBindViewHolder(VH holder, int position) {
        ...
        if (mViewPager.getLayoutManager().canScrollHorizontally()) {
            lp.width = mViewPager.getMeasuredWidth() / 3 - mViewPager.getPaddingLeft() - mViewPager
                    .getPaddingRight();
        } else {
            lp.height = mViewPager.getMeasuredHeight() / 3;
        }
