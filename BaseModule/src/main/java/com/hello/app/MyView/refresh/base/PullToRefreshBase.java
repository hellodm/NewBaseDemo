 ...
 *******************************************************************************/
package com.hello.app.MyView.refresh.base;
...
import com.hello.app.MyView.refresh.internal.FlipLoadingLayout;
import com.hello.app.MyView.refresh.internal.LoadingLayout;
import com.hello.app.MyView.refresh.internal.RotateLoadingLayout;
import com.hello.app.MyView.refresh.internal.Utils;
import com.hello.app.MyView.refresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
    ...
    /**
     * Called when the UI has been to be updated to be in the
     * {@link PullToRefreshBase.State#REFRESHING} or {@link PullToRefreshBase.State#MANUAL_REFRESHING}
     * state.
     *
    ...
    protected final void refreshLoadingViewsSize() {
        ...
        if (DEBUG) {
            Log.d(LOG_TAG, String.format("Setting Padding. L: %d, T: %d, R: %d, B: %d", pLeft, pTop,
                    pRight, pBottom));
        }
    ...
    public static interface OnPullEventListener<V extends View> {
         ...
         *                    {@link PullToRefreshBase.Mode#PULL_FROM_END} depending on which
         *                    direction
