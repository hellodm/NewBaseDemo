...
import com.hello.app.MyView.refresh.base.PullToRefreshBase.Mode;
import com.hello.app.MyView.refresh.base.PullToRefreshBase.State;
        ...
        if (view.isPullToRefreshOverScrollEnabled() && !view.isRefreshing()) {
            ...
            if (mode.permitsPullToRefresh() && !isTouchEvent && deltaValue != 0) {
                ...
                if (PullToRefreshBase.DEBUG) {
                    Log.d(LOG_TAG,
                            "OverScroll. DeltaX: " + deltaX + ", ScrollX: " + scrollX + ", DeltaY: "
                                    + deltaY
                ...
                if (newScrollValue < (0 - fuzzyThreshold)) {
                    ...
                    if (mode.showHeaderLoadingLayout()) {
                        ...
                        view.setHeaderScroll(
                                (int) (scaleFactor * (currentScrollValue + newScrollValue)));
                    }
