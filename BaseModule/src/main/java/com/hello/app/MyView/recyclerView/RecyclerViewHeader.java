...
//                (int) ViewUtil.dip2px(context,182));
//        lp.topMargin= (int) ViewUtil.dip2px(context,-482);
    ...
    private void setupAlignment(RecyclerView recycler) {
        if (!mAlreadyAligned) {
            ...
            if (currentParams != null) {
                newHeaderParams = new FrameLayout.LayoutParams(
                        getLayoutParams()); //to copy all the margins
...
//                ((ViewGroup) currentParent).setBackgroundColor(Color.GREEN);
    ...
    private void setupHeader(final RecyclerView recycler) {
        ...
        RecyclerViewHeader.this.getViewTreeObserver()
                    ...
                    public void onGlobalLayout() {
                        ...
                        if (height > 0) {
                            ...
                            recycler.addItemDecoration(
                                    new HeaderItemDecoration(recycler.getLayoutManager(), height),
                                    0);
                        }
                    }
                });
