package com.hello.app.circularavatar;
...
public class JoinLayout {
    ...
    private static final float[][] sizes = {new float[]{0.99f, 0.99f},
            new float[]{0.59f, 0.65f}, new float[]{0.5f, 0.8f},
     ...
     *
     * @param index      下标
     * @param sideLength 画布边长（正方形）
     * @param ratio      系数
     *                   ratio[0]直径缩放 ratio[1]边距
     * @return 下标index X，Y轴坐标
     */
    private static float[] offset2(int index, float sideLength, float[] ratio) {
        // 圆的直径
        float d = sideLength * ratio[0];
        // 边距 edge distance
        float ed = d * ratio[1];
